...
- `gateway/app/config.py` — `DEFAULTS` — full key list with seed values (`auto_stop_minutes`, `feeding_alert_minutes`, UI prefills, `activity_types`, `timed_activities`, timezone, `ui_show_count`).
