...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "act_feeding": "Milk",
        "act_solid_food": "Solid food / Water",
        "act_sleep": "Sleep",
        "act_poopoo": "Poopoo",
        ...
        "date_water_summary": "{n} time{plural} water",
        ...
        "water": "Water",
        "solid_food_type": "Food type",
        "solid_food_generic": "Solid food",
        ...
        "config_solid_food_locked": "Solid food / Water is always present and uses an end time",
        "config_solid_food_options": "Solid food types",
        "config_solid_food_options_hint": "Add or remove food types. Water is always available and needs no amount.",
    ...
    "zh": {
        ...
        "milk_amount": "奶量",
        "water": "水",
        "solid_food_type": "辅食类型",
        "solid_food_generic": "辅食",
        "feeding_type": "喂食类型",
        ...
        "config_solid_food_locked": "辅食/水始终存在并使用结束时间",
        "config_solid_food_options": "辅食类型",
        "config_solid_food_options_hint": "添加或删除辅食类型。水始终可选，无需填写份量。",
